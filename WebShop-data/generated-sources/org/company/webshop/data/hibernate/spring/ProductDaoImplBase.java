...
/**
 * Product Data Access Object (DAO) Implementation. Responsible for Creating,
 * Reading, Updating, Deleting and retrieving lists of Product objects in the database.
 * All database access is done here.
 *  
 * @author Generated by Mod4j
 */
public class ProductDaoImplBase extends HibernateDaoSupport
		implements
			ProductDaoBase {
	 ...
	 * {@inheritDoc}
	 */
	public Long add(Product object) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Product> listPage(final int firstResult, final int maxResults) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Product> listPageByExample(final ProductExample example,
	...
	public long count() {
		return ((Long) getHibernateTemplate().iterate(
				"select count(*) from Product").next()).longValue();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public long count(final ProductExample example) {
		Assert.notNull(example, "argument [example] may not be null");
		List<Integer> result;
		result = getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(final Session session)
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Product> findByExample(final ProductExample example) {
		Assert.notNull(example, "argument [example] may not be null");
		List<Product> result;
		result = getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(final Session session)
