...
import org.company.webshop.service.CustomerServiceModelLocalService;
...
public class SpringContextLoaderTest {
	...
	public final void setUp() throws Exception {
		...
		jndi.bind("java:comp/env/jdbc/WebShopDS", ds);
	...
	public final void testContextLoader() {
		BeanFactoryLocator locator = MyBeanFactoryLocator
				.getInstance("classpath*:/org/company/webshop/*/beanRefContext.xml");
		BeanFactoryReference reference = locator
				.useBeanFactory("org.company.webshop.service.Context");
