...
import org.company.webshop.domain.DerivedExample;
import org.company.webshop.service.dto.DerivedDto;
import org.mod4j.runtime.exception.ConcurrentUpdateException;
import org.springframework.util.Assert;

/**
 * Translator for translating Derived domain objects from- and to DerivedDto data transfer objects. 
 *
 * @author generated by Mod4j
 */
public class DerivedDtoTranslator {

	/**
	
	 * Translates a DerivedDto dto object into a Derived domain object.
	 * A new domain object will be created passed to the {@link #fromDto(DerivedDto, Derived)}.
	.
	 *
	 * @param source The {@link DerivedDto} object to translate, may not be {@code null}.
	 * @return {@link Derived}, the resulting domain object.
	 */
	public Derived fromDto(final DerivedDto source) {
		return fromDto(source, new HashMap<Object, Object>());
	}

	Derived fromDto(final DerivedDto source,
	...
	/**
	 * Translates a DerivedDto dto object into a Derived domain object. All properties in the dto will be mapped to the 
	 ...
	 * @return {@link Derived}, the resulting domain object.
	 */
	public Derived fromDto(final DerivedDto source, final Derived target) {
		return fromDto(source, target, new HashMap<Object, Object>());
	}

	Derived fromDto(final DerivedDto source, final Derived target,
			final Map<Object, Object> translated) {
	...
	/**
	 * Translates a Derived domain object into a DerivedDto dto object. Properties and associations of the domain object
	 ...
	 *
	 * @return DerivedDto The {@link DerivedDto} object translated from source.
	 */
	public DerivedDto toDto(final Derived source) {
	...
	/**
	 * Translates a DerivedDto dto object into a DerivedExample Example domain object. 
	 ...
	 *
	 * @param source The {@link DerivedDto} object to translate.
	 *
	 ...
	 */
	private void validateVersion(final DerivedDto source, final Derived target) {
