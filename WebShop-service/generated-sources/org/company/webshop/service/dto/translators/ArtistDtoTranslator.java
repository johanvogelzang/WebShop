...
import org.company.webshop.domain.ArtistExample;
import org.company.webshop.service.dto.ArtistDto;
import org.mod4j.runtime.exception.ConcurrentUpdateException;
import org.springframework.util.Assert;

/**
 * Translator for translating Artist domain objects from- and to ArtistDto data transfer objects. 
 *
 * @author generated by Mod4j
 */
public class ArtistDtoTranslator {

	/**
	.
	 *
	 * @param source The {@link ArtistDto} object to translate, may not be {@code null}.
	 * @return {@link Artist}, the resulting domain object.
	 */
	public Artist fromDto(final ArtistDto source) {
		return fromDto(source, new HashMap<Object, Object>());
	}

	Artist fromDto(final ArtistDto source, final Map<Object, Object> translated) {
	...
	/**
	 * Translates a ArtistDto dto object into a Artist domain object. All properties in the dto will be mapped to the 
	 ...
	 * @return {@link Artist}, the resulting domain object.
	 */
	public Artist fromDto(final ArtistDto source, final Artist target) {
		return fromDto(source, target, new HashMap<Object, Object>());
	}

	Artist fromDto(final ArtistDto source, final Artist target,
	...
	/**
	 * Translates a Artist domain object into a ArtistDto dto object. Properties and associations of the domain object
	 ...
	 *
	 * @return ArtistDto The {@link ArtistDto} object translated from source.
	 */
	public ArtistDto toDto(final Artist source) {
	...
	/**
	 * Translates a ArtistDto dto object into a ArtistExample Example domain object. 
	 ...
	 *
	 * @param source The {@link ArtistDto} object to translate.
	 *
	 ...
	 */
	private void validateVersion(final ArtistDto source, final Artist target) {
