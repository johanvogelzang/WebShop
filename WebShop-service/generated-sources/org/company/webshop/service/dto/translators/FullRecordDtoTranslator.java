...
/**
 * Translator for translating Record domain objects from- and to FullRecordDto data transfer objects. 
 *
 * @author generated by Mod4j
 */
public class FullRecordDtoTranslator {

	private RecordTypeEnumDtoTranslator typeTranslator = new RecordTypeEnumDtoTranslator();

	/**
	
	 * Translates a FullRecordDto dto object into a Record domain object.
	 * A new domain object will be created passed to the {@link #fromDto(FullRecordDto, Record)}.
	.
	 *
	 * @param source The {@link FullRecordDto} object to translate, may not be {@code null}.
	 * @return {@link Record}, the resulting domain object.
	 */
	public Record fromDto(final FullRecordDto source) {
		return fromDto(source, new HashMap<Object, Object>());
	}

	Record fromDto(final FullRecordDto source,
	...
	/**
	 * Translates a FullRecordDto dto object into a Record domain object. All properties in the dto will be mapped to the 
	 ...
	 * @return {@link Record}, the resulting domain object.
	 */
	public Record fromDto(final FullRecordDto source, final Record target) {
		return fromDto(source, target, new HashMap<Object, Object>());
	}

	Record fromDto(final FullRecordDto source, final Record target,
			final Map<Object, Object> translated) {
		...
		if (source.getMediumCode() != null) {
			target.setMediumCode(source.getMediumCode());
		}
	...
	/**
	 * Translates a Record domain object into a FullRecordDto dto object. Properties and associations of the domain object
	 ...
	 *
	 * @return FullRecordDto The {@link FullRecordDto} object translated from source.
	 */
	public FullRecordDto toDto(final Record source) {
		return toDto(source, new HashMap<Object, Object>());
	}

	FullRecordDto toDto(final Record source,
			final Map<Object, Object> translated) {
		if (translated.containsKey((source))) {
	...
	/**
	 * Translates a FullRecordDto dto object into a RecordExample Example domain object. 
	 ...
	 *
	 * @param source The {@link FullRecordDto} object to translate.
	 *
	 ...
	 */
	private void validateVersion(final FullRecordDto source, final Record target) {
