...
public class PropertyValidationTest {
    ...
    /**
     * Test method for {@link Customer#setNumberOfEars(int)}. According to the WebShop business domain model, a
    ...
    /**
     * Test method for {@link Customer#setUsername(String)}. According to the WebShop business domain model, the
    ...
    /**
     * Test method for {@link Customer#setEmailAddress(String)}. According to the WebShop business domain model, the
    ...
    /**
     * Test method for {@link Record#setPrice(float)}. According to the WebShop business domain model, the length of
